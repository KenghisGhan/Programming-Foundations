...
def fun_with_ids
  ...
  # d_outer would be the same as a_outer
  ...
  1.times do
    ...
    # These objects would have the same ID as a_outer_id
    ...
    # This would change the ID of each object
    ...
    # These IDs would be the same as the outer IDs
...
# Variables inside the block would no longer exist outside the block
...
def fun_with_ids
  ...
  # d_outer object ID would be the same as c_outer
...
def an_illustrative_method(a_outer, b_outer, c_outer, d_outer, a_outer_id, b_outer_id, c_outer_id, d_outer_id)
  ...
  # Each variable will have the same object IDs here
  ...
  # Each variable will have different object IDs here
  ...
  # Each variable will have different object IDs here as well
...
# my_string will remain the same, and my array will be altered.
...
# Change the name of the method to reflect what it does better, or make the results consistent with both strings and arrays.
