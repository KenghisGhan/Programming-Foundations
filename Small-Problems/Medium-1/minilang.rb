...
# Take in a string of commands
# Set register to 0
# Set stack to []
# Use String#split to split the commands
# Do Array#each on the split commands, with n as the block variable
#   case n
#     when push
#       append register to stack
#     when add
#       assign register the value of register + stack.pop
#     when sub
#       assign register the value of register - stack.pop
#     when mult
#       assign register the value of register * stack.pop
...
#       assign register the value of register % stack.pop
#     when pop
#       assign register the value of stack.pop
#     when print
#       puts register
#     else
#       register = n
