...
# Take in a year.
# If the year is divisble by four, check if it is divisible by 100.
# If it is divisible by 400, return true.
# If it is not, return false if it is divisible by 100.
# If it is divisble by 4 and neither of those are true, return true.
# Return false.
